...
export const getDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneDatasetOneFileNameMax = 255;

export const getDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneDatasetOneHeadersItemMax = 255;

export const getDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneDatasetOneHeadersMax = 100;

export const getDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneDatasetOneRowsItemMaxOne = 4000;

export const getDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneDatasetOneRowsMax = 10000;

export const getDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneDatasetOneIndicatorColumnsItemMax = 255;

export const getDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneDatasetOneIndicatorColumnsMax = 100;

export const getDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneMonthsMax = 120;


export const getDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneStatisticsItemOmittedMin = 0;

export const getDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneStatisticsItemStandardDeviationMin = 0;

export const getDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneStatisticsItemMovingRangeMeanMin = 0;

export const getDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneEvaluationOneSustainabilityPlanMin = 4;
export const getDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneEvaluationOneSustainabilityPlanMax = 4;
...
export const GetDmaicWorkspaceResponse = zod.object({
  ...
  "effort": zod.enum(['Alto', 'Baixo']),
  "quadrant": zod.enum(['Maior Interesse', 'Prioritário com Análise', 'Descartar', 'Ganhos Rápidos'])
})).optional().describe('Classificação esforço x impacto das causas da Sprint 3.'),
  "controlPhase": zod.union([zod.object({
  "dataset": zod.union([zod.object({
  "fileName": zod.string().max(getDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneDatasetOneFileNameMax),
  "headers": zod.array(zod.string().max(getDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneDatasetOneHeadersItemMax)).max(getDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneDatasetOneHeadersMax),
  "rows": zod.array(zod.record(zod.string(), zod.string().max(getDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneDatasetOneRowsItemMaxOne))).max(getDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneDatasetOneRowsMax),
  "dateColumn": zod.union([zod.string(),zod.null()]),
  "indicatorColumns": zod.array(zod.string().max(getDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneDatasetOneIndicatorColumnsItemMax)).max(getDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneDatasetOneIndicatorColumnsMax)
}).describe('Dataset interpretado localmente no navegador, sem os bytes do arquivo original.'),zod.null()]),
  "months": zod.number().min(1).max(getDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneMonthsMax),
  "selectedIndicators": zod.array(zod.string()),
  "statistics": zod.array(zod.object({
  "indicator": zod.string(),
  "count": zod.number().min(1),
  "omitted": zod.number().min(getDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneStatisticsItemOmittedMin),
  "mean": zod.number(),
  "standardDeviation": zod.number().min(getDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneStatisticsItemStandardDeviationMin),
  "minimum": zod.number(),
  "maximum": zod.number(),
  "movingRangeMean": zod.number().min(getDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneStatisticsItemMovingRangeMeanMin),
  "upperControlLimit": zod.number(),
  "lowerControlLimit": zod.number(),
  "latestValue": zod.number(),
  "baseline": zod.number(),
  "target": zod.number(),
  "improvementPp": zod.number(),
  ...
  "summary": zod.string(),
  "baseline": zod.number(),
  "postControlMean": zod.number(),
  "improvementPp": zod.number(),
  "financialGainReal": zod.string(),
  "financialCalculation": zod.string(),
  "sustainabilityPlan": zod.array(zod.object({
  "title": zod.string(),
  "owner": zod.string(),
  "cadence": zod.string(),
  "controls": zod.array(zod.string())
})).min(getDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneEvaluationOneSustainabilityPlanMin).max(getDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneEvaluationOneSustainabilityPlanMax)
}),zod.null()])
}),zod.null()]).optional().describe('Dados, cartas X-AM, avaliação IA e plano de sustentabilidade da Fase de Controle.')
...
export const saveDmaicWorkspaceBodyAnalysisArtifactsControlPhaseOneDatasetOneFileNameMax = 255;

export const saveDmaicWorkspaceBodyAnalysisArtifactsControlPhaseOneDatasetOneHeadersItemMax = 255;

export const saveDmaicWorkspaceBodyAnalysisArtifactsControlPhaseOneDatasetOneHeadersMax = 100;

export const saveDmaicWorkspaceBodyAnalysisArtifactsControlPhaseOneDatasetOneRowsItemMaxOne = 4000;

export const saveDmaicWorkspaceBodyAnalysisArtifactsControlPhaseOneDatasetOneRowsMax = 10000;

export const saveDmaicWorkspaceBodyAnalysisArtifactsControlPhaseOneDatasetOneIndicatorColumnsItemMax = 255;

export const saveDmaicWorkspaceBodyAnalysisArtifactsControlPhaseOneDatasetOneIndicatorColumnsMax = 100;

export const saveDmaicWorkspaceBodyAnalysisArtifactsControlPhaseOneMonthsMax = 120;


export const saveDmaicWorkspaceBodyAnalysisArtifactsControlPhaseOneStatisticsItemOmittedMin = 0;

export const saveDmaicWorkspaceBodyAnalysisArtifactsControlPhaseOneStatisticsItemStandardDeviationMin = 0;

export const saveDmaicWorkspaceBodyAnalysisArtifactsControlPhaseOneStatisticsItemMovingRangeMeanMin = 0;

export const saveDmaicWorkspaceBodyAnalysisArtifactsControlPhaseOneEvaluationOneSustainabilityPlanMin = 4;
export const saveDmaicWorkspaceBodyAnalysisArtifactsControlPhaseOneEvaluationOneSustainabilityPlanMax = 4;
...
export const SaveDmaicWorkspaceBody = zod.object({
  ...
  "controlPhase": zod.union([zod.object({
  "dataset": zod.union([zod.object({
  "fileName": zod.string().max(saveDmaicWorkspaceBodyAnalysisArtifactsControlPhaseOneDatasetOneFileNameMax),
  "headers": zod.array(zod.string().max(saveDmaicWorkspaceBodyAnalysisArtifactsControlPhaseOneDatasetOneHeadersItemMax)).max(saveDmaicWorkspaceBodyAnalysisArtifactsControlPhaseOneDatasetOneHeadersMax),
  "rows": zod.array(zod.record(zod.string(), zod.string().max(saveDmaicWorkspaceBodyAnalysisArtifactsControlPhaseOneDatasetOneRowsItemMaxOne))).max(saveDmaicWorkspaceBodyAnalysisArtifactsControlPhaseOneDatasetOneRowsMax),
  "dateColumn": zod.union([zod.string(),zod.null()]),
  "indicatorColumns": zod.array(zod.string().max(saveDmaicWorkspaceBodyAnalysisArtifactsControlPhaseOneDatasetOneIndicatorColumnsItemMax)).max(saveDmaicWorkspaceBodyAnalysisArtifactsControlPhaseOneDatasetOneIndicatorColumnsMax)
}).describe('Dataset interpretado localmente no navegador, sem os bytes do arquivo original.'),zod.null()]),
  "months": zod.number().min(1).max(saveDmaicWorkspaceBodyAnalysisArtifactsControlPhaseOneMonthsMax),
  "selectedIndicators": zod.array(zod.string()),
  "statistics": zod.array(zod.object({
  "indicator": zod.string(),
  "count": zod.number().min(1),
  "omitted": zod.number().min(saveDmaicWorkspaceBodyAnalysisArtifactsControlPhaseOneStatisticsItemOmittedMin),
  "mean": zod.number(),
  "standardDeviation": zod.number().min(saveDmaicWorkspaceBodyAnalysisArtifactsControlPhaseOneStatisticsItemStandardDeviationMin),
  "minimum": zod.number(),
  "maximum": zod.number(),
  "movingRangeMean": zod.number().min(saveDmaicWorkspaceBodyAnalysisArtifactsControlPhaseOneStatisticsItemMovingRangeMeanMin),
  "upperControlLimit": zod.number(),
  "lowerControlLimit": zod.number(),
  "latestValue": zod.number(),
  "baseline": zod.number(),
  ...
  "cadence": zod.string(),
  "controls": zod.array(zod.string())
})).min(saveDmaicWorkspaceBodyAnalysisArtifactsControlPhaseOneEvaluationOneSustainabilityPlanMin).max(saveDmaicWorkspaceBodyAnalysisArtifactsControlPhaseOneEvaluationOneSustainabilityPlanMax)
}),zod.null()])
}),zod.null()]).optional().describe('Dados, cartas X-AM, avaliação IA e plano de sustentabilidade da Fase de Controle.')
...
export const saveDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneDatasetOneFileNameMax = 255;

export const saveDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneDatasetOneHeadersItemMax = 255;

export const saveDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneDatasetOneHeadersMax = 100;

export const saveDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneDatasetOneRowsItemMaxOne = 4000;

export const saveDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneDatasetOneRowsMax = 10000;

export const saveDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneDatasetOneIndicatorColumnsItemMax = 255;

export const saveDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneDatasetOneIndicatorColumnsMax = 100;

export const saveDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneMonthsMax = 120;


export const saveDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneStatisticsItemOmittedMin = 0;

export const saveDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneStatisticsItemStandardDeviationMin = 0;

export const saveDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneStatisticsItemMovingRangeMeanMin = 0;

export const saveDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneEvaluationOneSustainabilityPlanMin = 4;
export const saveDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneEvaluationOneSustainabilityPlanMax = 4;
...
export const SaveDmaicWorkspaceResponse = zod.object({
  ...
  "controlPhase": zod.union([zod.object({
  "dataset": zod.union([zod.object({
  "fileName": zod.string().max(saveDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneDatasetOneFileNameMax),
  "headers": zod.array(zod.string().max(saveDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneDatasetOneHeadersItemMax)).max(saveDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneDatasetOneHeadersMax),
  "rows": zod.array(zod.record(zod.string(), zod.string().max(saveDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneDatasetOneRowsItemMaxOne))).max(saveDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneDatasetOneRowsMax),
  "dateColumn": zod.union([zod.string(),zod.null()]),
  "indicatorColumns": zod.array(zod.string().max(saveDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneDatasetOneIndicatorColumnsItemMax)).max(saveDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneDatasetOneIndicatorColumnsMax)
}).describe('Dataset interpretado localmente no navegador, sem os bytes do arquivo original.'),zod.null()]),
  "months": zod.number().min(1).max(saveDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneMonthsMax),
  "selectedIndicators": zod.array(zod.string()),
  "statistics": zod.array(zod.object({
  "indicator": zod.string(),
  "count": zod.number().min(1),
  "omitted": zod.number().min(saveDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneStatisticsItemOmittedMin),
  "mean": zod.number(),
  "standardDeviation": zod.number().min(saveDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneStatisticsItemStandardDeviationMin),
  "minimum": zod.number(),
  "maximum": zod.number(),
  "movingRangeMean": zod.number().min(saveDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneStatisticsItemMovingRangeMeanMin),
  "upperControlLimit": zod.number(),
  "lowerControlLimit": zod.number(),
  "latestValue": zod.number(),
  "baseline": zod.number(),
  ...
  "cadence": zod.string(),
  "controls": zod.array(zod.string())
})).min(saveDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneEvaluationOneSustainabilityPlanMin).max(saveDmaicWorkspaceResponseAnalysisArtifactsControlPhaseOneEvaluationOneSustainabilityPlanMax)
}),zod.null()])
}),zod.null()]).optional().describe('Dados, cartas X-AM, avaliação IA e plano de sustentabilidade da Fase de Controle.')
}).describe('Current derived data and generated artifacts associated with a DMAIC project.'),
 ...
 */
export const runDmaicControlEvaluationBodyProblemStatementMax = 4000;

export const runDmaicControlEvaluationBodyMonthsMax = 120;


export const runDmaicControlEvaluationBodyStatisticsItemOmittedMin = 0;

export const runDmaicControlEvaluationBodyStatisticsItemStandardDeviationMin = 0;

export const runDmaicControlEvaluationBodyStatisticsItemMovingRangeMeanMin = 0;

export const runDmaicControlEvaluationBodyStatisticsMax = 20;



export const RunDmaicControlEvaluationBody = zod.object({
  "problemStatement": zod.string().min(1).max(runDmaicControlEvaluationBodyProblemStatementMax),
  "projectCharterContext": zod.object({
  "projectName": zod.string(),
  "client": zod.string(),
  "area": zod.string(),
  ...
  "months": zod.number().min(1).max(runDmaicControlEvaluationBodyMonthsMax),
  "statistics": zod.array(zod.object({
  "indicator": zod.string(),
  "count": zod.number().min(1),
  "omitted": zod.number().min(runDmaicControlEvaluationBodyStatisticsItemOmittedMin),
  "mean": zod.number(),
  "standardDeviation": zod.number().min(runDmaicControlEvaluationBodyStatisticsItemStandardDeviationMin),
  "minimum": zod.number(),
  "maximum": zod.number(),
  "movingRangeMean": zod.number().min(runDmaicControlEvaluationBodyStatisticsItemMovingRangeMeanMin),
  "upperControlLimit": zod.number(),
  "lowerControlLimit": zod.number(),
  "latestValue": zod.number(),
  "baseline": zod.number(),
  ...
  "improvementPp": zod.number(),
  "values": zod.array(zod.number()).optional()
})).min(1).max(runDmaicControlEvaluationBodyStatisticsMax)
})

export const runDmaicControlEvaluationResponseSustainabilityPlanMin = 4;
export const runDmaicControlEvaluationResponseSustainabilityPlanMax = 4;



export const RunDmaicControlEvaluationResponse = zod.object({
  "success": zod.boolean(),
  "summary": zod.string(),
  "baseline": zod.number(),
  "postControlMean": zod.number(),
  ...
  "cadence": zod.string(),
  "controls": zod.array(zod.string())
})).min(runDmaicControlEvaluationResponseSustainabilityPlanMin).max(runDmaicControlEvaluationResponseSustainabilityPlanMax)
})
