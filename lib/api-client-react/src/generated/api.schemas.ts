...
export type DmaicCauseMatrixRowScores = {[key: string]: number};
...
export interface DmaicMatrixCriterion {
  id: string;
  name: string;
  weight: number;
}

export type DmaicSolutionMatrixRowScores = {[key: string]: number};
...
export type DmaicEffortImpactRowImpact = typeof DmaicEffortImpactRowImpact[keyof typeof DmaicEffortImpactRowImpact];


export const DmaicEffortImpactRowImpact = {
  Alto: 'Alto',
  Baixo: 'Baixo',
} as const;
